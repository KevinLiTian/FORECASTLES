...
shelter_occupancy <- read_csv("C:/Users/miche/OneDrive - University of Toronto/UNIVERSITY COURSES/YEAR 4/EXTERNAL/Borealis AI project/daily-shelter-overnight-service-occupancy-capacity-2022.csv")
